...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  InceptionV3| 图片分类推理模型。是Pytorch框架模型。  |  请参考[https://github.com/Huawei-Ascend/modelzoo/tree/master/built-in/ACL_PyTorch/Official/cv/InceptionV3_for_Pytorch](https://github.com/Huawei-Ascend/modelzoo/tree/master/built-in/ACL_PyTorch/Official/cv/InceptionV3_for_Pytorch)目录中README.md下载原始模型。 |
