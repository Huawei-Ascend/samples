...
训练过程参考 [MobileNetV2垃圾分类](https://github.com/Huawei-Ascend/samples/wikis/MobileNetV2%E5%9E%83%E5%9C%BE%E5%88%86%E7%B1%BB?sort_id=3404387)
...
- 请确认已按照[环境准备和依赖安装](https://github.com/Huawei-Ascend/samples/tree/master/python/environment)准备好环境。
...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    | mobilenetV2 | 图片分类推理模型。是基于mindspore的mobilenetv2模型。 | 请参考[https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/garbage_classification/ATC_mobilenetv2_mindspore_AE](https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/garbage_classification/ATC_mobilenetv2_mindspore_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
