...
2. 获取此应用中所需要的原始网络模型。
    ...
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    | mobilenetV2 | 图片分类推理模型。是基于mindspore的mobilenetv2模型。 | 请参考[https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/Research/cv/garbage_classification/ATC_mobilenetv2_tf_AE](https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/Research/cv/garbage_classification/ATC_mobilenetv2_tf_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
