...
- 请确认已按照[环境准备和依赖安装](https://github.com/Huawei-Ascend/samples/tree/master/cplusplus/environment)准备好环境。
...
2. 获取此应用中所需要Davinci模型。
    ...
    - 20.0版本    
        ...
        |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
        |---|---|---|
        |  DeblurGAN| 图像变清晰模型。是基于Tensorflow的DeblurGAN模型。  |  请参考[https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/Blur2Sharp/ATC_DeblurGAN_tf_AE](https://github.com/Huawei-Ascend/modelzoo/tree/master/contrib/TensorFlow/Research/cv/Blur2Sharp/ATC_DeblurGAN_tf_AE)目录中README.md下载原始模型章节下载模型文件。 |
