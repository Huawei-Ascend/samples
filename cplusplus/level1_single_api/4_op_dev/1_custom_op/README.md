...
-   Scope融合规则样例
    ...
    Scope融合规则实现样例，请参见[tf_scope_fusion_pass](https://github.com/Huawei-Ascend/samples/tree/dev/cplusplus/level1_single_api/4_op_dev/1_custom_op/framework/tf_scope_fusion_pass)：
    ...
    Scope融合算子适配插件实现文件，请参见[tf_plugin](https://github.com/Huawei-Ascend/samples/blob/dev/cplusplus/level1_single_api/4_op_dev/1_custom_op/framework/tf_plugin)：
